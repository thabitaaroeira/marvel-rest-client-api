...
/**
 * Representação da entidade de Criador. Segundo a documentação oficial: <br/>
 * Creators are the people and entities that make comics. They are assigned to
 * the specific comic stories on which they worked, but we bubble up those
 * assignments to the issues, series and events in which the stories appear as a
 * convenience.
 */
public class Creator extends BaseEntity {
	...
	public String toString() {
		return "Creator [firstName=" + firstName + ", middleName=" + middleName + ", lastName=" + lastName + ", suffix="
				+ suffix + ", fullName=" + fullName + ", comics=" + comics + ", stories=" + stories + ", series="
