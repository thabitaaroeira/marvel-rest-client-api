...
/**
 * Representação da entidade de Personagem. Segundo a documentação oficial:
 * <br/>
 * Characters are people and organizations which appear in comics. They are also
 * assigned to stories initially and bubbled up to issues, series and events.
 */
public class Character extends BaseEntity {
	...
	public String toString() {
		return "Character [name=" + name + ", description=" + description + ", comics=" + comics + ", stories="
				+ stories + ", events=" + events + ", series=" + series + "]";
	}
